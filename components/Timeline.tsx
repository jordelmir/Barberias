                        ...
                        {barbers.map(barber => (
                            <div key={barber.id} className="w-[200px] flex-shrink-0 p-3 border-r border-white/5 flex items-center gap-3 bg-dark-900/50">
                                ...
                                <div className="min-w-0">
                                    <h3 className="font-bold text-gray-200 text-xs truncate leading-none mb-1">{barber.name.split(' ')[0]}</h3>
                                    <p className="text-[8px] text-brand-500/70 font-black uppercase tracking-widest leading-none">
                                        {barber.tier}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="flex relative" style={{ height: `${timelineHeight}px` }}>
                            ...
                            <div className="w-16 flex-shrink-0 border-r border-white/5 bg-dark-950/40 z-20 backdrop-blur-xs sticky left-0">
                                {hours.map(hour => (
                                    ...
                                    >
                                        <span className="relative -top-2 px-1 rounded">{hour > 12 && hour !== 24 ? hour - 12 : hour}{hour >= 12 && hour !== 24 ? 'pm' : 'am'}</span>
                                    </div>
                                ))}
                            </div>
